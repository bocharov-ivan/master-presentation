...
\begin{frame}
\frametitle{Признаковое описание документа}
В данной работе используется модифицированная схема выбора весов для слова, явно учитывающая положение слова в текста. Пусть $d[i]$ - это слово, находящееся в документе $d$ на позиции $i$. Тогда вес слова вычисляется по формуле:
